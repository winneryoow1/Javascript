...
//生成类的实例对象也是使用new命令
    ...
    /*
    console.log(Object.keys(point1._proto_)); //[]
    console.log(Object.keys(Point1.prototype)); //[]
    console.log(Point1.prototype === point1._proto_); //true
    ...
    //  configurable: true }
    */
   //注：getOwnPropertyDescriptor()用于查询一个属性的描述符，并以对象的形式返回
...
console.log(exp1._proto_ === Exp.prototype); //false
console.log(exp1._proto_ === exp2._proto_); //true
...
//如果将这个方法提取出来单独使用，this会指向该方法运行时所在的环境,因而找不到此方法
...
for(let argument of new ContainerGenerator('I', 'love', 'jj', 'haha')) {
...
//直接在Foo类上调用
console.log(ContainStaticMethod.getLocaleTime()); // static func 2018-9-12
...
function testTargetOfNew() {
    ...
    new Foo(); //[Function: Point] [Function: Foo] [Function: Foo]
